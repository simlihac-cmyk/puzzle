...
set "DEPLOY_CMD=zsh -lc 'cd ~/puzzle-deploy && cp docker-compose.yml docker-compose.yml.bak && git restore docker-compose.yml && git pull && docker compose up -d && docker compose restart puzzle-api && docker compose ps'"
